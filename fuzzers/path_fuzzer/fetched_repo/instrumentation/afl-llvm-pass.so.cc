...
// CYHADDED: 去掉字符串首尾的空白字符 ---------------------------------------------------------------- end


// CYHADDED: 函数 --- 获取第一个空格前的子串 --------------------------------------------------------- start
std::string substrBeforeFirstSpace(std::string originalStr) {
    std::string returnStr = originalStr;
    size_t pos = returnStr.find(' ');
...
// CYHADDED: 函数 --- 获取第一个空格前的子串 --------------------------------------------------------- end


// CYHADDED: 对 BBID 文件的操作 --------------------------------------------------------------------- start
...
// CYHADDED: 对 BBID 文件的操作 --------------------------------------------------------------------- end


// CYHADDED: 对文件的操作 --------------------------------------------------------------------- start
