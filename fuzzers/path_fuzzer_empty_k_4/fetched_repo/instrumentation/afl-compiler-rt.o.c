...
// CYHADDED: path_inject_eachbb 的定义 ------------------------ start
#include <stdbool.h>
...
char formattedContent[100]; // 定义一个足够大的字符数组来存储格式化后的内容
